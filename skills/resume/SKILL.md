...
allowed-tools: ["mcp__plugin_keepgoing_keepgoing__get_momentum", "mcp__plugin_keepgoing_keepgoing__get_reentry_briefing"]
---

The user wants a quick re-entry briefing for this project.

1. Call `mcp__plugin_keepgoing_keepgoing__get_momentum` to get the current session state and recent activity.
2. Call `mcp__plugin_keepgoing_keepgoing__get_reentry_briefing` to get structured context (last checkpoint, next step, blockers).
