...
allowed-tools: ["mcp__plugin_keepgoing_keepgoing__get_whats_hot"]
---

The user wants to see what's currently active across their project.

Call `mcp__plugin_keepgoing_keepgoing__get_whats_hot` to get recently touched files and active branches.
