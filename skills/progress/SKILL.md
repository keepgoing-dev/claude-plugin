...
allowed-tools: ["mcp__plugin_keepgoing_keepgoing__get_session_history", "mcp__plugin_keepgoing_keepgoing__get_momentum"]
---

The user needs a progress summary for a standup, sprint review, or personal review.

1. Call `mcp__plugin_keepgoing_keepgoing__get_session_history` with a higher limit (20) for broader session coverage.
2. Call `mcp__plugin_keepgoing_keepgoing__get_momentum` for current branch context.
